        ...
        <div className="card bg-base-100  shadow-sm ">
            ...
            <div className="card-body ">
                <div className='flex flex-col md:flex-row md:gap-16'>
                    ...
                    <p className=' flex items-center gap-4  '><span className='gap-4'><IoMdTimer size={24} fill='blue' /></span>{date} - {time}</p>
                </div>
                <h2 className="card-title px-3 text-blue-500">{title}</h2>
                <p className='px-3'>{description}</p>
                <div className='flex flex-col md:flex-row md:gap-16'>
                    <p className=' flex items-center gap-4 my-2 mt-2 '><span className='gap-4'><BiSolidCategoryAlt size={24} fill='blue' /></span>{category}</p>
