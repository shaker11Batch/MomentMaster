...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow my-2 md:px-20">
            <div className="navbar-start">
                ...
                <Link to='/' className=" text-3xl font-bold text-secondary"> <span className='text-blue-500'>MomentMaster</span></Link>
            </div>
